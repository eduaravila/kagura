...
description: "Discover the secrets of constructing a TTS system from the ground up, and unleash your creativity by utilizing our TTS building system to design your very own TTS solution."
...
## Architecture
  ...
  In line with the clean architecture approach, each app will be deployed in a docker container and will have its database. Postgres has been chosen as the database of choice. Deployment management will be done using Dokku. The project structure will follow a clean architecture structure, as detailed in this [link](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html).
